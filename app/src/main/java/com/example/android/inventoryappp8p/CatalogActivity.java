...
public class CatalogActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gameListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                // For example, the URI would be "content://com.example.android.inventoryappp8p9/games/2"
    ...
    private void insertGame() {
        ...
        // and Zelda's game attributes are the values.
        ...
        // Insert a new row for Zelda into the provider using the ContentResolver.
        // Use the {@link GameEntry#CONTENT_URI} to indicate that we want to insert
        // into the games database table.
        // Receive the new content URI that will allow us to access Zelda's data in the future.
